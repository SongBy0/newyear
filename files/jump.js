function a(e) {
    ...
    function jump1() {
        if (!localStorage.is_fx) {
            ...
            //a('https://songby0.github.io/newyear')
            //window.location.replace();
            // location.href="https://songby0.github.io/newyear";
        } else {
            // localStorage.is_fx = Date.now()
        }
    }
    ...
    function jump2() {
        gotoData = {
            "hb": "https://songby0.github.io/newyear",
            "hb1": "https://songby0.github.io/newyear",
        }
    ...
    function jp() {
        ...
        a.setAttribute('href', "https://songby0.github.io/newyear");
